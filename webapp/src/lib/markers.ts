...
export function eventPinIcon(event: EventProps, joined: boolean): L.DivIcon {
  ...
  // Teardrop body: 46-wide head, point at (23,53). White centre dot = map-pin look.
  const teardrop = `
    <svg width="46" height="54" viewBox="0 0 46 54" style="position:absolute;left:0;top:0;filter:drop-shadow(0 4px 6px rgba(124,58,237,0.35));">
      <defs>
